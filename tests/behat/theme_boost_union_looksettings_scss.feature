...
Feature: Configuring the theme_boost_union plugin for the "SCSS" tab on the "Look" page
  ...
  Scenario Outline: Setting: External SCSS - Add external SCSS download URL to the theme
    ...
    Examples:
      | urlfield                        | url                                                                                                                   |
      | External Pre SCSS download URL  | https://raw.githubusercontent.com/moodle-an-hochschulen/moodle-theme_boost_union/issue-41/tests/fixtures/extscss.scss |
      | External Post SCSS download URL | https://raw.githubusercontent.com/moodle-an-hochschulen/moodle-theme_boost_union/issue-41/tests/fixtures/extscss.scss |
  ...
  Scenario Outline: Setting: External SCSS - Add a broken SCSS download URL / invalid external SCSS code to the theme
    ...
    Examples:
      ...
      | https://raw.githubusercontent.com/moodle-an-hochschulen/moodle-theme_boost_union/issue-41/tests/fixtures/extscss-invalid.scss |
